...
type GetContactsResponse struct {
	...
	Data []*ContactObject `protobuf:"bytes,1,rep,name=data,proto3" json:"data,omitempty"`
...
const file_profile_v1_profile_proto_rawDesc = "" +
	...
	"\x04data\x18\x01 \x01(\v2\x19.profile.v1.ContactObjectR\x04data\"L\n" +
	"\x12GetContactsRequest\x126\n" +
	"\x03ids\x18\x01 \x03(\tB$\xbaH!\x92\x01\x1e\b\x01\x10d\"\x18r\x16\x10\x03\x18(2\x10[0-9a-z_-]{3,40}R\x03ids\"e\n" +
	...
	"\x0econtact_manage\x12\xcf\x02\n" +
	"\vGetContacts\x12\x1e.profile.v1.GetContactsRequest\x1a\x1f.profile.v1.GetContactsResponse\"\xfe\x01\xbaG\xe3\x01\n" +
	"\bContacts\x12\x12Get contacts by id\x1a\xb5\x01Fetches ContactObjects for one or more contact ids regardless of profile attachment. Use a single id for one contact, or many for batch resolve (e.g. product-stored cv_contact_ids).*\vgetContacts\x82\xb5\x18\x10\n" +
	"\x0econtact_manage\x90\x02\x01\x12\xd5\x02\n" +
